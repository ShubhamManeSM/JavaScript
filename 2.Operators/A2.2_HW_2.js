...
console.log("1.1");
let rajestRating = 8.2;
let amitRating = 7.9;

let isRajeshHigherRated = rajestRating > amitRating;
...
console.log("Can product quantity be sold in batches of 5?",isDivisibleBy5)
console.log("Can product quantity be sold in batches of 10?",isDivisibleBy10)

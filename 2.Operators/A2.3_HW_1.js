...
let meetsCriteria = tvScreenSize >= 50 && tvBrand === "Sony" && tvPrice <= 60000;
...
let isDiscountApplicable = watchReleaseYear === currentYear - 1 && (watchSize === "M" || watchSize === "L") && (watchBrand === "Apple" || watchBrand === "Samsung");

...
function generateClassReport(studentsData){
  ...
  report += "Total Average of Maths: " + englishAverage + "\n"
  report += "Total Average of Maths: " + scienceAverage + "\n"
  report += "Total Average of Maths: " + computersAverage + "\n"

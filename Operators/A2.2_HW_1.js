...
let isAkshayHeightJump = akshayHeight > raviHeight;

console.log("Did Akshay jump higher than Ravi?",isAkshayHeightJump);
...
let yamunaCricketClubScore = 78;
let narmadaCricketClubScore = 78;
let godavariCricketClubScore = 78;
